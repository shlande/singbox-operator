...
// ProxyUserWebhook handles defaulting and validation for ProxyUser.
type ProxyUserWebhook struct{}

func (w *ProxyUserWebhook) Default(ctx context.Context, user *v1alpha1.ProxyUser) error {
...
func SetupProxyUserWebhookWithManager(mgr ctrl.Manager) error {
	return ctrl.NewWebhookManagedBy(mgr, &v1alpha1.ProxyUser{}).
		WithDefaulter(&ProxyUserWebhook{}).
